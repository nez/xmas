...
curl -L -O -f -m 120 --connect-timeout 5 --retry 5 --retry-connrefused --retry-max-time 60 --no-progress-meter https://github.com/clojure/brew-install/releases/download/1.12.4.1618/clojure-tools-1.12.4.1618.tar.gz
echo "13769da6d63a98deb2024378ae1a64e4ee211ac1035340dfca7a6944c41cde21  clojure-tools-1.12.4.1618.tar.gz" | sha256sum -c | grep "^clojure-tools-1.12.4.1618.tar.gz: OK$"
tar xzf clojure-tools-1.12.4.1618.tar.gz
...
install -m644 clojure-tools/clojure-tools-1.12.4.1618.jar "$clojure_lib_dir/libexec/clojure-tools-1.12.4.1618.jar"
...
rm -rf clojure-tools
rm -rf clojure-tools-1.12.4.1618.tar.gz
